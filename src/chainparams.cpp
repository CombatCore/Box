...
{
    const char* pszTimestamp = "Lets go baby!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1524769653, 3265811, 0x1e0ffff0, 1, 50 * COIN);
	...
	*/
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000cfc14a3ac86310d71aae351a344765809045fa05c4378bbc08ca14bd25"));
        assert(genesis.hashMerkleRoot == uint256S("0xd5d08b485d6d4bd290fee3fb120e2122d58379d9d66173e6ba2eb7e3c3f6c25e"));
